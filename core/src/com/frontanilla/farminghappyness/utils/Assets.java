...
public class Assets {
    ...
    public static TextureRegion tree, river1, river2, river3, river4, farmingTile, grass, defenseTile,
            turret, turretCannon, tourist, rangeCircle, turretBullet, sidesLifeBar, centerLifeBar, centerEmptyLifeBar;
